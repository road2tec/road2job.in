    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <?php if (!empty($mockSession['video_path'])): ?>
                <video controls controlsList="nodownload noremoteplayback" disablePictureInPicture oncontextmenu="return false;" style="width:100%;max-width:640px;border-radius:var(--r2j-radius);" src="<?= url($mockSession['video_path']) ?>"></video>
            <?php else: ?>
